        ...
        <div className="row g-5">
          <div className="col-lg-3 col-md-6">
            ...
            <p className="mb-2">
              ...
              3212, M.G. Road, Ratnagiri, Maharashtra, India
            </p>
            <p className="mb-2">
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <div className="get-involved-links">
              <Link className="btn btn-link" to="/get-involved#membership-sign-ups">Membership Sign-Ups</Link>
              <Link className="btn btn-link" to="/get-involved#become-a-sponsor">Become a Sponsor</Link>
            </div>
          </div>
          <div className="col-lg-3 col-md-6">
            ...
            <div className="quick-links">
              ...
              <Link className="btn btn-link" to="/events">Events</Link>
